...
void UpdatePlayingState(Game& game, float deltaTime)
{
    if (game.isGameFinished)
    {
        ...
        return; // äàëüøå íå èäåò, ïîêà íå çàêîí÷èòñÿ UpdateGameOverState. (3 ñåêóíäû)
    }
...
// óïðàâëåíèå è àêòèâíàÿ ëîãèêà òèêà. 
...
void SetGameSettings(Game& game)
{
    ...
    // ÎÏÐÅÄÅËßÅÒ ÑÊÎÐÎÑÒÜ ÈÃÐÛ Â ÇÀÂÈÑÈÌÎÑÒÈ ÎÒ ÂÛÁÐÀÍÍÎÉ ÑËÎÆÍÎÑÒÈ.
    // ÒÎ ÏÐÎÈÇÂÎÄÈÒÑß ÇÀÄÅÐÆÊÀ ÑÊÀÆÅÌ ÄÎ 200 ÌÑ, ÏÎÊÀ Ñ×ÅÒ×ÈÊ ÍÅ ÍÀÏÎËÍÈÒÑß ÄÎ ÍÅÎÁÕÎÄÈÌÎÃÎ ÊÎËÈ×ÅÑÒÂÀ ×ÅÐÅÇ ÊÀÊÎÅ ÒÎ ÊÎËÈ×ÅÑÒÂÎ ÖÈÊËÎÂ. 
