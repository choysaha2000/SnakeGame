...
// ÁÈÒÎÂÀß ÌÀÑÊÀ ÑÎÅÄÈÍÅÍÈÉ ÑÅÃÌÅÍÒÀ ÇÌÅÈ Ñ ÑÎÑÅÄßÌÈ 
// ÈÑÏÎËÜÇÓÅÒÑß ÄËß ÂÛÁÎĞÀ ÏĞÀÂÈËÜÍÎÉ ÒÅÊÑÒÓĞÛ
...
struct Snake
{
	...
	uint8_t connectionMask = 0; // ìàñêà äëÿ ñâÿçåé
	bool needsUpdate = true; // Ôëàã îáíîâëåíèÿ òåêñòóğû
